...
const DeleteUserScreen = () => {
  ...
  const { deleteUser, loading, fetchUserById, selectedUser } = useUserStore();
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.banner, { backgroundColor: theme.colors.primary }]}>
          <Text style={styles.bannerText}>Are you want to delete this user?</Text>
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput style={styles.input} value={password} editable={false} secureTextEntry={true} />
        </View>

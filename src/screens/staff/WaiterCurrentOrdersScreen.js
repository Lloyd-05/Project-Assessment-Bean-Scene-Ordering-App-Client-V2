...
const WaiterCurrentOrdersScreen = () => {
        ...
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.buttonRow}>
                    <TouchableOpacity style={[styles.pastOrdersButton, { backgroundColor: theme.colors.beanDarkBlue }]} onPress={() => navigation.navigate('pastOrdersList')}>
                        <Text style={[styles.buttonText, { color: theme.colors.white }]}>View Past Orders</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[styles.startButton, { backgroundColor: theme.colors.beanDarkBlue }]} onPress={() => navigation.navigate('waiterCreateOrders')}>
                        <Text style={[styles.buttonText, { color: theme.colors.white }]}>Start Ordering</Text>
                    </TouchableOpacity>
                </View>
...
export default WaiterCurrentOrdersScreen;
